 ...
 * @author Dell
 */
public class Online3donorarrival extends javax.swing.JFrame {
public static int [] arrivalTimedonor = new int[1000];
...
setIconImage(iicon.getImage());
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Arrival Time of Donor");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        for(int i=0;i<Online.donor;i++)
        {
            ...
            JLabel l = new JLabel("Arrival Time of donor No. "+(i+1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Online3donorarrival.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Online3donorarrival().setVisible(true);
            }
        });
    }
